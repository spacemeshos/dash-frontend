...
const MapTitle = ({ title, toolTipMessage }: Props) => (
  <div className="mapTitle-wrap">
    <div className="mapTitle-text">
      { title }
    </div>
    <div className="mapTitle-icons">
      <svg data-tip data-for="map-tooltip" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
      ...
      <ReactTooltip place={mobile() ? 'left' : 'top'} id="map-tooltip" aria-haspopup="true">
