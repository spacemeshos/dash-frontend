  ...
  return (
    <div className="tileTitle-wrap">
      ...
      <div className="tileTitle-icons">
        <svg className="icon-tooltip" viewBox="0 0 10 10" data-tooltip-content data-for={`tile-tooltip-${icon}`} xmlns="http://www.w3.org/2000/svg">
        ...
        {toolTipMessage && (
          <Tooltip effect="float" className="tileTitle-tooltip" place={mobile() ? 'left' : 'right'} id={`tile-tooltip-${icon}`} arrowColor="transparent" aria-haspopup="true">
