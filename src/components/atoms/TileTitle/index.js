...
const TileTitle = (props: Props) => {
  const { title, toolTipMessage, icon, url } = props;
  ...
  return (
    <div className="tileTitle-wrap">
      ...
      <div className="tileTitle-icons">
        ...
        {toolTipMessage && (
          <ReactTooltip className="tileTitle-tooltip" place={mobile() ? 'left' : 'right'} id={`tile-tooltip-${icon}`} arrowColor="transparent" aria-haspopup="true">
